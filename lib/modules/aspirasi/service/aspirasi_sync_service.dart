...
class AspirasiSyncService {
  static const String collectionName = 'aspirasi';

  static final AspirasiSyncService _instance =
      AspirasiSyncService._internal();

  AspirasiSyncService._internal();

  factory AspirasiSyncService() => _instance;
  ...
  Future<void> _syncItem(Map<String, dynamic> item) async {
    ...
    switch (operation) {
      ...
      case SyncQueueOperation.delete:
        ...
        await HiveService.aspirasiBox.delete(documentId);
        break;
    }
  }
  ...
  Future<void> _markLocal(String documentId, String syncStatus) async {
    final value = HiveService.aspirasiBox.get(documentId);
    if (value is! Map) return;

    await HiveService.aspirasiBox.put(documentId, {
