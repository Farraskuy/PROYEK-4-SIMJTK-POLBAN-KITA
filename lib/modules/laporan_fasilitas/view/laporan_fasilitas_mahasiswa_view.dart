...
class MahasiswaLaporanController extends GetxController {
  ...
  final RxList<LaporanFasilitasModel> myLaporan =
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: 12, color: _C.textSecondary, height: 1.4),
          ),
        ],
      ),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: const Text('Buat laporan pertama Anda',
        ...
        children: [
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(laporan.pelaporDisplayName,
                                    style: const TextStyle(
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(laporan.lokasiLabKelas,
                                style: const TextStyle(
                                    fontSize: 12,
          ...
          if (laporan.fotoUrls.isNotEmpty)
            ClipRRect(
              ...
              child: Image.network(laporan.fotoUrls.first,
